                ...
                <div id="bjui-collapse0" class="panel-collapse panelContent collapse in">
                    <div class="panel-body" >
                        <ul id="bjui-tree0" class="ztree ztree_main" data-toggle="ztree" data-on-click="MainMenuClick" data-expand-all="true">
                        	<li data-id="passRead" data-pid="0">文章管理</li>
                        	<li data-id="passRead_0" data-pid="passRead" data-url="<%=request.getContextPath()%>/article/index.do" data-tabid="passRead_0" data-fresh="true" data-reloadWarn="true">查看文章</li>
